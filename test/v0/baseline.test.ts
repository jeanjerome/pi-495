...
describe("what the candidate did to the tree, and the reuse of a reference pass (VER-08)", () => {
	...
	it("a reference pass is reused for the same sensor, reference, environment and protocol, never across a change of any of them", () => {
		...
		const control = { control_id: "unit", version: "1", title: "t", command: ["node", "--test"], cwd: ".", env_allowlist: [], env: {}, timeout_ms: 1000, parser: "node-test" as const, report_path: null, structure_rules: [], scope_argument: null, network: "denied" as const, writable_paths: [], requirement_refs: [], protected: true, protected_paths: [] };
