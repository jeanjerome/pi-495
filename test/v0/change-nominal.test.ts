...
describe("change nominal cycle (SA-001, PF-13, DEC-01)", () => {
	...
	it("integrates with IH-11 authorization and confirms G6", () => {
		...
		r.create()
			.g0({ ...await_mandate(), integration: "local_branch" })
			.g1()
			.g2()
			.g3()
			.implement();
		...
		r.run({
			...
			request: {
				...
				recommendation: null,
				options: [
					{ id: "integrate", label: "Intégrer", effect: "applique", risky: true },
					{ id: "export_only", label: "Exporter", effect: "rien", risky: false },
				],
