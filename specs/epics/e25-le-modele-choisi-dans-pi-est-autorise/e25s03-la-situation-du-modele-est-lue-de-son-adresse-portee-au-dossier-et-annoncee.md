...
6l. **Modèle choisi par une extension chargée avant 495, avant l'ouverture de 495** — une telle
extension qui sélectionne un modèle dans son propre `session_start` le fait avant que la session de
495 ne s'ouvre. Cette sélection n'est pas jugée à l'étape 7 : l'ouverture de 495 lit le modèle actif
à ce moment et le juge à l'étape 6. S'il est hors de la machine, il est donc annoncé une fois, par
l'ouverture. Un modèle remplacé avant l'ouverture de 495 n'est pas annoncé : il n'est plus le modèle
actif quand elle a lieu, et aucune intervention ne le lit.
