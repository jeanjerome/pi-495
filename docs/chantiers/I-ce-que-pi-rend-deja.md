...
```
Dans ~/Projets/495-pi-package, lis D-35 dans docs/DECISIONS.md, la règle `presentation` de
...
Écris la décision retenue dans docs/DECISIONS.md avec son motif et sa conséquence, et mets la
