...
| L | une réponse à une question matérielle qui n'atteint pas les exigences | ouvert, et c'est lui qui commande l'ordre : un changement accepté rend `400` là où son propriétaire avait décidé `422`, et le protocole gelé exige ce `400` en égalité stricte ; le parcours nominal, retrouvé sur les deux cycles et les deux modèles | [L-reponse-humaine-sans-effet.md](L-reponse-humaine-sans-effet.md) |
