...
| F | une sortie structurée refusée, et le changement qui n'a plus d'issue | ouvert : la reprise d'un blocage réessayable est corrigée (`D-38`) et éprouvée en campagne, mais le recours de `extractJsonOutput` perd un rapport complet et valide parce qu'il cherche par la fin | [F-sortie-structuree-refusee.md](F-sortie-structuree-refusee.md) |
| L | une réponse à une question matérielle qui n'atteint pas les exigences | ouvert : la réouverture et le report des réponses sont écrits (`D-37`, `D-39`) et éprouvés jusqu'à G0, mais `gateG1` refuse sur un prédicat plus large que celui qui rouvre, et un rapport qui défait une liaison sans poser de question boucle sans recours | [L-reponse-humaine-sans-effet.md](L-reponse-humaine-sans-effet.md) |
