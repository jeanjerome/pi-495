...
const OUTPUT_SCHEMA_TEXT: Record<string, string> = {
	...
	"specification-report": '{"objective": string, "facts": string[], "assumptions": string[], "questions": [{"id": string, "question": string, "material": boolean}], "out_of_scope": string[], "risks": string[], "requirements": [{"requirement_id": string, "statement": string, "mandatory": boolean, "criterion": string, "category": string, "satisfied_by_reference": boolean}], "design": {"summary": string, "components": string[], "interfaces": string[], "risks": string[]}}',
};
