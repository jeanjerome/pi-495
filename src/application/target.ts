...
export function detectStack(projectPath: string, requirementRefs: RequirementRef[], nodeBinary = process.execPath): StackDetection {
	...
	if (existsSync(pomPath)) {
		...
		return { stack: "maven", facts: { pom: true }, controls, positive_witness: { "src/test/java/PositiveWitness495Test.java": "import org.junit.jupiter.api.Test;\nimport static org.junit.jupiter.api.Assertions.assertEquals;\npublic class PositiveWitness495Test { @Test void runnerReportsAPassingTest() { assertEquals(1, 1); } }\n" }, negative_witness: { "src/test/java/NegativeWitness495Test.java": "import org.junit.jupiter.api.Test;\nimport static org.junit.jupiter.api.Assertions.assertEquals;\npublic class NegativeWitness495Test { @Test void injectedDefectMustBeDetected() { assertEquals(1, 2); } }\n" }, capability_missing: [] };
	}
	return { stack: "unknown", facts: {}, controls: [], positive_witness: {}, negative_witness: {}, capability_missing: ["no qualified target adapter for this project (package.json or pom.xml expected)"] };
}
