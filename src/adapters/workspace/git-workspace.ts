...
export const DEFAULT_WORKSPACE_POLICY: WorkspacePolicy = { exclusions: ["node_modules/", "target/", "dist/", ".pi/", "__pycache__/", ".venv/"], max_file_bytes: 8 * 1024 * 1024, max_entries: 50_000 };
